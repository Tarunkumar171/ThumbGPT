...
export default function Navbar() {
    ...
    return (
        <>
            <motion.nav
                className='relative top-0 z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur'
            ...
            >
                <Link to='/'>
                    <img src='/thumbgptlogo.png' alt='logo' className='h-25 w-auto' />
                </Link>
